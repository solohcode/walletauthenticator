              ...
              <div className="row pt-2 animate-bottom">
                <div className="col-4 text-center">
                  <div className="card border-0 bg-transparent animate-left">
                    <div className="text-center">
                      <img alt="crypto" src={d1} className="img-fluid mx-auto w-[60px] md:w-[100px]" style={{ width: '100px' }} />
                ...
                <div className="col-4 text-center">
                  <div className="card border-0 bg-transparent animate-opacity">
                    <div className="text-center">
                      <img alt="crypto" src={d2} className="img-fluid mx-auto w-[60px] md:w-[100px]" style={{ width: '100px' }} />
                ...
                <div className="col-4 text-center">
                  <div className="card border-0 bg-transparent animate-right">
                    <div className="text-center">
                      <img alt="crypto" src={d3} className="img-fluid mx-auto w-[60px] md:w-[100px]" style={{ width: '100px' }} />
